...
CATEGORY_URL = "https://www.livelaw.in/high-court/karnataka-high-court"
...
OUTPUT_FILE = os.path.join(DATA_DIR, "Karnataka_HC_articles.json")
...
def is_valid_article_url(url):
    ...
    if "/high-court/karnataka-high-court/" not in path:
        return False
